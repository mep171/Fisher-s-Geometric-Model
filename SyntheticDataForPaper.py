# -*- coding: utf-8 -*-
"""
Created on Thu Nov 20 10:11:48 2025
...
regression_obj=RegressionProblem(landscape_obj, Simulated_fitness, Norm,key2)
...
plt.savefig("MtoMPlots\SyntheticFitness.pdf", dpi=300)
plt.show()
...
# Assuming the previous loop has been run and 'results' dictionary is populated
